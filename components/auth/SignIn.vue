...
<template>
  <form class="grid gap-6" @submit="onSubmit">
    ...
    <div class="grid gap-2">
      ...
      <Input id="email" v-model="form.email" type="email" placeholder="name@example.com" :disabled="isLoading"
    ...
    <Button type="button" class="w-full" :disabled="isLoading" @click="onSubmit">
